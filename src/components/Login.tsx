  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#FAF9F5] text-[#1B3022] font-body relative overflow-hidden selection:bg-[#1B3022]/20 p-6">
      ...
      >
        ...
        {/* Google Login Button */}
        <button className="w-full bg-white border border-outline-variant hover:border-[#1B3022] text-[#1B3022] font-body text-sm font-bold tracking-wide py-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 flex items-center justify-center gap-3">
        ...
        <button className="w-full bg-[#1B3022] text-[#FAF9F5] font-body text-sm font-bold tracking-widest uppercase py-4 rounded-xl shadow-lg hover:bg-[#0C1510] hover:shadow-xl transition-all duration-300">
          Continue with Email
        </button>
